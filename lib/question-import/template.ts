    ...
    sections: [
      {
        ...
        children: [
          ...
          new Paragraph("Subtopic: Integer operations"),
          new Paragraph("Subskill: Add negative integers"),
          new Paragraph("Competency: Understanding"),
          new Paragraph("Process: Employ"),
          new Paragraph("Prerequisite: Directed number meaning"),
          new Paragraph("Representation Mode: symbolic"),
          new Paragraph("Conceptual-Procedural Load: balanced"),
          new Paragraph("Calculation Load: light"),
          new Paragraph("Foundation Role: core"),
          new Paragraph("Time Target Sec: 60"),
          new Paragraph("Misconception Family: sign-direction-confusion"),
          ...
          new Paragraph("6. The same canonical tag schema is also available in the XLSX import template."),
        ],
      },
    ],
  });
