...
import { COMPANY_NAME, HOME_DESCRIPTION, PRODUCT_NAME } from "@/lib/seo";
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          <div
            style={{ maxWidth: 980, fontSize: 30, color: "#e2e8f0", lineHeight: 1.35 }}
          >
            {HOME_DESCRIPTION}
          </div>
        </div>
        ...
        <div
          style={{ display: "flex", justifyContent: "space-between", fontSize: 24, color: "#bfdbfe" }}
        >
          <div>Assess, manage, and deliver with confidence.</div>
