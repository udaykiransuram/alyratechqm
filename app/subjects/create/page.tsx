        ...
        <aside className="app-editor-aside">
          <Card className="app-surface overflow-hidden">
            <CardHeader className="app-section-header">
              ...
              <CardDescription>Keep subject records predictable for the whole school workspace.</CardDescription>
            </CardHeader>
            <CardContent className="app-section-body">
              <div className="app-note-list">
                <div className="app-note-item">
                  Use the formal subject name that should appear in papers, reports, and filters.
                </div>
                <div className="app-note-item">
                  Subject codes are optional, but they help when staff work across multiple similar subjects.
                </div>
                <div className="app-note-item">
                  Add tags here if you already know the curriculum mapping you want authors to follow.
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="app-surface overflow-hidden">
            <CardHeader className="app-section-header">
              ...
              <CardDescription>What this subject unlocks next.</CardDescription>
            </CardHeader>
            <CardContent className="app-section-body">
              <div className="app-note-list">
                <div className="app-note-item">
                  Questions can be created and filtered against this subject immediately after saving.
                </div>
                <div className="app-note-item">
                  Question papers inherit cleaner subject selection when the library is maintained here first.
                </div>
              </div>
            </CardContent>
          </Card>
