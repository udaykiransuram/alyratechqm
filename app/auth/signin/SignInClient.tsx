...
export default function SignInClient({
  ...
  const passwordHint = isStudentStyleIdentifier
    ? "If this is the first student login, use the saved phone-number digits."
    : "";
    ...
    try {
      ...
      if (!result || !result.ok) {
        const errorMessage =
          ...
          (isStudentStyleIdentifier
            ? "We couldn't sign in with that roll number and password. If this is your first login, try using the saved phone-number digits exactly as stored (including country code digits, if saved)."
