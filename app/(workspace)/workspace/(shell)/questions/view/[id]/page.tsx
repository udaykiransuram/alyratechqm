...
type ViewQuestionOption = {
  content?: string;
};

type ViewQuestionMatrixOption = {
  left?: string;
  right?: string;
};
...
export default async function ViewQuestionPage({
  ...
  const question = (await getWorkspaceQuestionById(
    schoolKey,
    id,
  )) as ViewQuestion | null;
