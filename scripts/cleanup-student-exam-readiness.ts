...
import { deleteExamRuntimeDataForSchool } from "@/lib/exam-runtime";
import {
...
async function cleanupReadinessData(args: ParsedArgs) {
...
async function main() {
  ...
  const summary = await cleanupReadinessData(args);

  console.log("[student-readiness-cleanup] complete");
