...
const AlertDialogPortal = ({
  ...props
}: AlertDialogPortalProps) => <AlertDialogPrimitive.Portal {...props} />
...
>(({ className, container, ...props }, ref) => (
  <AlertDialogPortal container={container}>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-[calc(100%-2rem)] max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 overflow-y-auto rounded-[calc(var(--app-radius-lg)+2px)] border border-border/60 bg-background/96 p-6 shadow-[0_30px_64px_-34px_hsl(var(--app-shadow-deep)/0.46)] backdrop-blur duration-200 supports-[backdrop-filter]:bg-background/92 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%]",
        className,
      )}
      {...props}
    />
