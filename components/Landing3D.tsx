...
export function Hero3D({ whatsappHref }: Hero3DProps) {
  ...
  return (
    <section
      ...
      className="relative flex min-h-[80vh] w-full items-center overflow-hidden bg-[#050505] sm:min-h-[88vh] md:min-h-screen"
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col items-center px-6 py-12 text-center sm:px-8 md:items-start md:px-16 md:py-14 md:text-left">
        <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-white/12 bg-black/40 px-4 py-1.5 text-sm font-medium text-emerald-300 shadow-xl shadow-black/20 backdrop-blur-md">
        ...
        <div className="w-full max-w-4xl">
          <GlassPanel
            className="mx-3 border border-white/15 p-6 shadow-[0_30px_80px_rgba(0,0,0,0.35)] sm:mx-0 sm:p-7 md:p-10"
          ...
          >
            ...
            <div className="flex flex-col items-center gap-5 sm:flex-row">
              ...
              {finalWhatsappHref ? (
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-full bg-[#25D366] px-6 py-3 font-semibold text-white shadow-lg transition-colors hover:bg-[#1ebd5a] sm:px-8 sm:py-4"
                >
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3 text-xs text-white/85 sm:text-sm">
              <span className="rounded-full border border-white/20 bg-white/10 px-3 py-1.5 backdrop-blur">
                AI-driven diagnostics
              </span>
              <span className="rounded-full border border-white/20 bg-white/10 px-3 py-1.5 backdrop-blur">
                School to class to student clarity
              </span>
              <span className="rounded-full border border-white/20 bg-white/10 px-3 py-1.5 backdrop-blur">
...
function ButtonShiny({
  ...
  return (
    <Link
      href={href}
      className={[
        "group relative rounded-full px-6 py-3 text-base font-semibold transition-all duration-300 hover:-translate-y-0.5 active:scale-95 sm:px-8 sm:py-4 sm:text-lg",
        primary
