...
export function SectionEditor({
  ...
  return (
    <>
      <div className="space-y-3.5 border-b border-border/60 bg-[linear-gradient(180deg,hsl(var(--app-surface-1)/0.98)_0%,hsl(var(--app-surface-tint)/0.16)_100%)] px-4 py-4">
        <div className="grid gap-3 xl:grid-cols-[minmax(0,1fr)_220px] xl:items-start">
          <div className="min-w-0 rounded-[calc(var(--app-radius-lg)+0.125rem)] border border-border/60 bg-[linear-gradient(180deg,hsl(var(--app-surface-1)/0.99)_0%,hsl(var(--app-surface-2)/0.82)_100%)] p-4 shadow-[0_18px_30px_-26px_hsl(var(--app-shadow-deep)/0.14)]">
            ...
            <div className="mt-3 grid gap-3 lg:grid-cols-[minmax(0,1fr)_136px_136px]">
            ...
            <p className="mt-3 text-xs leading-5 text-muted-foreground">
              Keep this part simple: set the section name and default marking first. Extra notes can stay optional until you actually need them.
            </p>
          </div>

          <div className="rounded-[calc(var(--app-radius-lg)+0.125rem)] border border-border/60 bg-[linear-gradient(180deg,hsl(var(--app-surface-1)/0.98)_0%,hsl(var(--app-surface-2)/0.8)_100%)] p-3.5 shadow-sm">
            <div className="flex items-start justify-between gap-3">
              ...
              <Button
                variant="ghost"
                size="icon-sm"
                className="rounded-full border border-border/60 bg-background/88 shadow-none hover:bg-background"
                onClick={onRemove}
        ...
        <div className="flex flex-col gap-2 rounded-[calc(var(--app-radius-lg)+0.05rem)] border border-border/60 bg-background/76 px-3.5 py-3 sm:flex-row sm:items-center">
