...
export default function LiveSessionYouTubeEmbedPanel({
  ...
  return (
    <div className="rounded-[1.2rem] border border-border/60 bg-background/72 p-4">
      ...
      <div className="mt-4 overflow-hidden rounded-[1rem] border border-border/60 bg-black shadow-[0_20px_44px_-34px_hsl(var(--app-shadow-deep)/0.5)]">
