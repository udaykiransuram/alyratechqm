                    ...
                    {group.items.map((item) => {
                      ...
                      if (directChild) {
                        return (
                          <AppPrefetchLink
                            ...
                            className={cn(
                              "app-sidebar-item flex items-center gap-3 rounded-[var(--app-radius-md)] px-3 py-2 text-sm transition-colors",
                      ...
                      return (
                        <div key={item.label} className="app-nav-panel p-1.5">
                          <div className="app-nav-text flex items-center gap-3 px-2 py-1.5 text-sm font-medium">
                            <span className="app-sidebar-item-icon">
                              <Icon className="h-4 w-4 shrink-0" />
                            </span>
                            <span>{item.label}</span>
                            ...
                            {item.children.map((child) => {
                              ...
                              return (
                                <AppPrefetchLink
                                  ...
                                  className={cn(
                                    "app-sidebar-subitem block rounded-[var(--app-radius-sm)] px-3 py-1.5 text-sm transition-colors",
                                    childActive
